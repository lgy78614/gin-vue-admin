...
// @Accept application/json
// @Produce application/json
// @Param data query K8sReq.K8sClustersSearch true "成功"
// @Success 200 {object} response.Response{data=object,msg=string} "成功"
// @Router /k8sClusters/k8sclusters [GET]
func (k8sClustersApi *K8sClustersApi) GetK8sClusterInfo(c *gin.Context) {
	// 创建业务用Context
	ctx := c.Request.Context()
	// 请添加自己的业务逻辑

	err := k8sClustersService.GetK8sClusterInfo(ctx)
	if err != nil {
