  ...
  <el-input v-model="searchInfo.name" placeholder="搜索条件" />
    ...
    <div class="gva-table-box">
        ...
        <el-table-column type="selection" width="55" />
            ...
            <el-table-column align="left" label="Service" prop="serviceType" width="120" />

            <el-table-column align="left" label="Cluster IP" prop="clusterIp" width="120" />

            <el-table-column align="left" label="端口配置" prop="ports" width="120" />

            <el-table-column align="left" label="Pod选择器" prop="selector" width="120" />

            <el-table-column align="left" label="Ingress特有" prop="ingressHosts" width="120" />
   ...
   <template #default="scope">{{ formatDate(scope.row.creationTimestamp) }}</template>
    ...
    {{ detailForm.clusterIp }}
                    ...
                    <el-descriptions-item label="端口配置">
    {{ detailForm.ports }}
</el-descriptions-item>
                    <el-descriptions-item label="Pod选择器">
    {{ detailForm.selector }}
</el-descriptions-item>
                    <el-descriptions-item label="Ingress特有">
